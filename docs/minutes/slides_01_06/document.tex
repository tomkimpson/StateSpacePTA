...
\begin{frame}
	What about different realisations of:
	\begin{itemize}
...
\end{frame}
	...
	\only<1>{%
		\tikz[overlay,remember picture]
		\node[fill=white,text=black] at ([xshift=1.5cm,yshift=3.5cm]current page.center){As Slide \ref{first_slide}, 5 noise realisations. (See also Slide \ref{iota_histogram})};
	}
...
\begin{frame}
	That was for 5 noise realisations - easy to show on corner plot.
...
\begin{frame} [label={iota_histogram}]
	Case examples - $(\iota, h)$ c.f. Slide \ref{first_slide_noise}
	
	
	
	\includegraphics[width=0.48\textwidth,height=0.5\textwidth]{images/single_histogram_iota_gw}
	\includegraphics[width=0.48\textwidth,height=0.5\textwidth]{images/single_histogram_h}
	
	(See also `notebooks/2.Multiple\_noise\_realisations.ipynb`)
\end{frame}
...
\includegraphics[width=0.85\textwidth,height=0.65\textwidth]{images/BayesRatioPlot}
...
\begin{frame}{Bayes ratios}
	...
	\includegraphics[width=0.85\textwidth,height=0.65\textwidth]{images/BayesRatioPlot_stacked}
