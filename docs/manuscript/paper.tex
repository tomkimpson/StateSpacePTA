...
We can use our state-space tools  to try to solve the problem of GW detection with a PTA i.e. "Is there evidence of a GW in my data?. 
...
%https://arxiv.org/abs/2211.03201
