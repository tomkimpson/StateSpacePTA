...
For each realisation of the noise we infer a marginalised 1-D posterior for each parameter. 
...
High SNR makes the posteriors effectively point estimates. Therefore maybe credible intervals dont make as much sense 
