...
\textcolor{red}{TK: TBD. Will show some likelihood plots and how the likelihood optima does not coincide with the injection value when the pulsar term is dropped.}
...
\begin{figure*}
   ...
   \medskip
	...
	\caption{}\label{fig:likelihood_curves}
\end{figure*}
