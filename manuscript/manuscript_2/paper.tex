...
In order to include the pulsar terms in an inference model and apply the methods of K23 it is necessary to be able to handle the noisy likelihood curves presented in Section \ref{sec:pulsar_terms_challenge}.


Whilst computational methods for approximate inference from noisy likelihoods do exists \citep[e.g.][]{doi:10.1137/21M1410853,2021arXiv210403942J,2019arXiv190501252J}
