...
class KalmanFilter:
    ...
    def __init__(self,Model, Observations,PTA):
        ...
        #Add the pulsar guys as knowns for now 
        self.f    = PTA.f 
        self.fdot = PTA.fdot
        self.d    = PTA.d
        self.gamma = PTA.γ
    ...
    def likelihood(self,parameters):
        ...
        omega_gw,phi0_gw,psi_gw,iota_gw,delta_gw,alpha_gw,h = parameters 
        f,fdot,gamma,d,sigma_p,sigma_m =  self.f,self.fdot,self.gamma,self.d,self.sigma_p,self.sigma_m
