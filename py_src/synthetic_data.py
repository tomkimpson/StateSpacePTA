...
class SyntheticData:
    ...
    def __init__(self,pulsars,P):
        ...
        #Pulsar parameters
        γ= pulsars.γ  
        σp = np.full((Npsr,1),pulsars.σp) #Vector of process noises - currently all the same
        ...
        if P.use_psr_terms_in_data:
            ...
            logging.info("Attention: You are including the PSR terms in your synthetic data generation")
        else:
            GW_function = gw_earth_terms
            logging.info("Attention: You are using just the Earth terms in your synthetic data generation")
