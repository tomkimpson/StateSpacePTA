...
measurement_model =  sys.argv[2]          # whether to use the H0(null) or H1(earth/pulsar) model
seed              = int(sys.argv[3])      # the seeding
num_gw_sources    = int(sys.argv[4])      # how many gw sources?
