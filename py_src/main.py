...
if __name__=="__main__":
    ...
    P   = SystemParameters(h=1e-2,σp=0.0,σm=1e-13,use_psr_terms_in_data=True,use_psr_terms_in_model=False,noise_model=False)       # define the system parameters as a class
