...
def bilby_inference_run(arg_name,h,measurement_model,seed):
    ...
    #Setup the system
    P   = SystemParameters(h=h,σp=True,σm=1e-11,use_psr_terms_in_data=True,measurement_model=measurement_model,seed=seed) # define the system parameters as a dict. Todo: make this a class
    ...
    #Surface the correct parameters 
    ...
    BilbySampler(KF,init_parameters,priors,label=arg_name,outdir="../data/nested_sampling/",npoints=2000)
